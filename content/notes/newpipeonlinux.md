---
title: How to Set NewPipe as Default YouTube App on Arch Linux GNOME | Step-by-Step Tutorial
tags:
  - Arch
  - Linux
  - GNOME
  ...
  - Privacy
  - Flatpak
description: Step-by-step guide to set NewPipe as default YouTube app on Arch Linux GNOME. Open YouTube links directly in privacy-focused NewPipe instead of browser. Includes wrapper script, MIME types, and troubleshooting for Firefox users.
keywords: NewPipe Arch Linux, set NewPipe default YouTube, GNOME YouTube handler, Arch Linux tutorial, privacy YouTube client, xdg-open YouTube, Flatpak NewPipe, Linux MIME types, YouTube wrapper script
image: attachment/newpipe.png
date: 2025-11-06
---
![How to Set NewPipe as Default YouTube App on Arch Linux GNOME | Tutorial Cover Image](newpipe.webp)
